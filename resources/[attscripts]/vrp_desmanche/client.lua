...
-----------------------------------------------------------------------------------------------------------------------------------------
local telefones = {
	{ 190.25,-1044.68,29.33 },
	{ 187.54,-1043.81,29.33 },	
	{ 56.03,-1079.90,29.45 },
	{ 55.20,-1081.55,29.45 },
	{ 491.74,-507.02,28.48 }
}
		...
		if not inService then
			...
			if not IsPedInAnyVehicle(ped) then
				...
				for k,v in pairs(telefones) do
					...
					if distance <= 20 then
						DrawMarker(21,v[1],v[2],v[3]-0.6,0,0,0,0.0,0,0,0.5,0.5,-0.4,255,0,0,0,0,0,0,1)
		...
		if inService then
			...
			if IsPedInAnyVehicle(ped) then
				...
				for k,v in pairs(desCoords) do
					local distance = Vdist(x,y,z,v[1],v[2],v[3])
					if distance <= 50 then
						DrawMarker(23,v[1],v[2],v[3]-0.96,0,0,0,0,0,0,5.0,5.0,0.5,240,200,80,40,0,0,0,0)
