...
local listaCarros = {
    "policiacharger2018", "policiasilverado", "policiaexplorer", "policiabmwr1200", "policiatahoe", "policiataurus",
    "fbi2", "policiavictoria", "policiamustanggt", "policiaschaftersid", "policet","policiacapricesid",
    "pbus","riot","policiaheli"
}

local listaPcs = {
    {x=441.67236328125, y=-978.81140136719, z=30.689674377441, h=178.6392364502},
    {x=459.79409790039, y=-989.33605957031, z=24.914764404297, h=266.82632446289},
    {x=473.2204284668, y=-988.22576904297, z=24.9147605896, h=351.9426574707},
    {x=472.68786621094, y=-984.05841064453, z=24.914764404297, h=84.775100708008},
    {x=469.39221191406, y=-998.36859130859, z=24.914758682251, h=269.32177734375},
    {x=-1071.08, y=-823.24, z=5.48,h=160.15393066406},
    {x=-1097.14, y=-818.35, z=19.04, h=321.45928955078},
    {x=-1097.6, y=-839.67, z=19.01, h=100.4859654346},
    {x=-1095.42, y=-814.37, z=5.49, h=67.37075686035},
    -- {x=1853.1613769531, y=3690.0422363281, z=34.267036437988, h=316.53973388672},
    {x=1851.95, y=3690.96, z=34.29, h=18.43},
    {x=-449.3274230957, y=6012.5625, z=31.716369628906, h=61.702407836914},
    {x=125.7, y=-767.13, z=242.15, h=232.21},
    {x=109.83, y=-750.96, z=242.15, h=3.83},
    {x=-441.59, y=6012.77, z=27.99, h=170.0},
}
...
function funcClient.carroPrisao(id, tempo)
	...
	if HasModelLoaded(vhash) then
        ...
        pveh04 = CreatePedInsideVehicle(nveh,27,GetHashKey("s_m_y_swat_01"),1,true,false)
        ...
        setPedPropertys(pveh04,armas[math.random(1,#armas)])
        ...
        SetEntityAsMissionEntity(pveh04s,  true, false)
                ...
                if distancia < 5.0 and math.ceil(vehspeed) < 3 then
                    if IsPedSittingInAnyVehicle(ped) then
                        ...
                        SetTimeout(3000, function()
                            ...
                            SetEntityAsNoLongerNeeded(pveh04)
