...
function func.Identidade(user_id)
    ...
    if user_id then
        ...
        if groupv == "Mafia" or groupv == "Mafia2" or groupv == "Crips" or groupv == "Motoclub" or groupv == "Ballas" or
            groupv == "Vagos" or groupv == "Groove" or groupv == "Desmanche" or groupv == "Bloods" or groupv == "Liberty" then groupv = "" end
