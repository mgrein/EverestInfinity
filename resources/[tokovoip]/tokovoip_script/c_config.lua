TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannel = "CONECTADO",
		TSPassword = "bolafifa123", -- TeamSpeak channel password (can be empty)
		...
		TSServer = "everestroleplay.ts3games.top", -- TeamSpeak server address to be displayed on blocking screen
