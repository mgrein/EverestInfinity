...
emP = Tunnel.getInterface("emp_farm_ilegal")
...
local Coordenadas = {
	{954.27,-114.77,75.02},-- MOTOCLUB
	{-1881.29,2060.95,140.99}, -- MAFIA 
}
...
local locs = {
	...
	[23] = { ['x'] =  1838.06, ['y'] = 3907.85, ['z'] = 33.26 }, -- 1838.06,3907.85,33.26
	[24] = { ['x'] = 1987.82, ['y'] = 3788.69, ['z'] = 32.19 },
	[25] = { ['x'] = 2122.46, ['y'] = 4784.47, ['z'] = 40.98 },
	[26] = { ['x'] = 11904.15, ['y'] = 4932.7, ['z'] = 48.97 },
	[27] = { ['x'] = -8.27, ['y'] = 6487.1, ['z'] = 31.52 },
	[28] = { ['x'] = -87.8, ['y'] = 6494.56, ['z'] = 32.1 },
	[29] = { ['x'] = -227.39, ['y'] = 6378.11, ['z'] = 31.76 },
	[30] = { ['x'] = -442.0, ['y'] = 6197.55, ['z'] = 29.56 },
	[31] = { ['x'] = -320.18, ['y'] =  6085.44, ['z'] = 31.47 },
	[32] = { ['x'] = 474.05, ['y'] = 2590.76, ['z'] = 44.44 },
	[33] = { ['x'] = -201.66, ['y'] = 2462.23, ['z'] = 55.69 },
				...
				if distance <= 30.0 then
					if distance <= 1.2 then
						...
						if IsControlJustPressed(0,38) and emP.checkPermission() then
							if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()),954.27,-114.77,75.02,true) <= 1.2 then
								servico = true	
								inicio = 1
								fim = 11						
								selecionado = math.random(inicio,fim)
								CriandoBlip(locs,selecionado)
							elseif GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()),-1881.29,2060.95,140.99,true) <= 1.2 then
								servico = true							
								inicio = 12
								fim = 22					
								selecionado = math.random(inicio,fim)
