...
function emP.checkPermission()
	...
	if user_id then
		if vRP.hasPermission(user_id,"ballas.permissao") or vRP.hasPermission(user_id,"groove.permissao") or vRP.hasPermission(user_id,"vagos.permissao")   or vRP.hasPermission(user_id,"crips.permissao") or vRP.hasPermission(user_id,"vanilla.permissao") or vRP.hasPermission(user_id,"bloods.permissao") or vRP.hasPermission(user_id,"mafia2.permissao") or vRP.hasPermission(user_id,"bahamas.permissao")  or vRP.hasPermission(user_id,"liberty.permissao") then
			return true
		else
