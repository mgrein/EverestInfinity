$(document).ready(function(){
	...
	document.onkeyup = function(data){
		if (data.which == 27){
			$.post("http://gago_mafia/shopClose");
		}
	};
});
...
const armasList = () => {
	$.post("http://gago_mafia/armasList",JSON.stringify({}),(data) => {
		let i = 0;
...
$(document).on("click",".comprar",function(){
	...
	if($el && amount > 0){
		$.post("http://gago_mafia/shopBuy",JSON.stringify({
