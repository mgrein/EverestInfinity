...
Citizen.CreateThread(function()
	while true do
		...
		DrawMarker(2,carx,cary,carz+1.97,0,0,0,180.0,0,0,1.0,1.0,1.5,240,200,80,100,1,1,0,0)
	end
end)
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(0)
		DrawMarker(23,mx,my,mz-0.92,0,0,0,180.0,0,0,10.0,10.0,1.0,240,200,80,80,0,0,0,0)
	end	
end)
