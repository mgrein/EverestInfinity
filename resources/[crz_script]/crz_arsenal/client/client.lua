...
local arsenal = {
    {452.3,-980.07,30.69}, {1841.54,3692.07,34.29},
    ...
    while isPolice do
        ...
        for _, lugares in pairs(arsenal) do
            ...
            DrawMarker(21, x, y + 0.0, z - 0.40, 0, 0, 0, 0, 0.0, 0.0, 0.75,
                       1.0, 0.50, 255, 255, 255, 75, true, true, 2, nil, false)
            if distance <= 1 then
...
RegisterNUICallback('Agua', function()
    ...
    GiveWeaponToPed(ped, GetHashKey("WEAPON_BZGAS"), 1, 0, 1)
    vRPServer.webHook("Granada de Gás")
end)
