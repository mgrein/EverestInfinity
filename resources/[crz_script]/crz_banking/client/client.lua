...
vRP._prepare("vRP/get_jogadores","SELECT COUNT(id) FROM vrp_users")
...
local Bancos = {
	{name="Banco", id=108, x=150.266, y=-1040.203, z=29.374},   -- 1037.72,3579.2,34.49
	{name="Banco", id=108, x=-1212.980, y=-330.841, z=37.787},
	{name="Banco", id=108, x=1037.72, y=3579.2, z=34.49},
...
if BancoMenu then
    ...
    while true do
        Wait(0)
        if nearBanco() or nearATM() then
                DisplayHelpText("Press ~INPUT_PICKUP~ to access your account~b~")
