...
local CoordenadaX = 308.42
local CoordenadaY = -602.37
...
local payment = 10
-----------------------------------------------------------------------------------------------------------------------------------------
-- LOCALIDADES   402.29992675781,-1921.1733398438,24.74450302124
-----------------------------------------------------------------------------------------------------------------------------------------
local locs = {
	...
	[6] = { ['x'] = 402.29, ['y'] = -1921.17, ['z'] = 24.74, ['xp'] = 335.73, ['yp'] = -2010.77, ['zp'] = 22.31, ['h'] = 228.25 },
...
Citizen.CreateThread(function()
	while true do
		...
		if emservico then
			...
			if distance <= 50.0 and IsVehicleModel(vehicle,GetHashKey("paramedicoambu")) or IsVehicleModel(vehicle,GetHashKey("paramedicotahoe")) or IsVehicleModel(vehicle,GetHashKey("paramedicocharger2014")) then
