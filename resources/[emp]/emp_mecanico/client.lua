...
local servico = false
local selecionado = 0
local CoordenadaX = -323.56
local CoordenadaY = -129.53
            ...
            if servico then
                ...
                if distance <= 30.0 then
                    ...
                    if distance <= 2.5 then
                        ...
                        if IsControlJustPressed(0, 38) and emP.checkPermission() then
                            if IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("flatbed")) or IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("towtruck")) then
