...
-----------------------------------------------------------------------------------------------------------------------------------------
local caixas = {
    [1] = {['seconds'] = 22, max = 25000, police = 2},
    [2] = {['seconds'] = 34, max = 25000, police = 2},
    [3] = {['seconds'] = 34, max = 25000, police = 2},
    [4] = {['seconds'] = 30, max = 25000, police = 2},
    [5] = {['seconds'] = 28, max = 25000, police = 2},
    [6] = {['seconds'] = 28, max = 25000, police = 2},
    [7] = {['seconds'] = 30, max = 25000, police = 2},
    [8] = {['seconds'] = 34, max = 25000, police = 2},
    [9] = {['seconds'] = 30, max = 25000, police = 2},

    [10] = {['seconds'] = 55, max = 25000, police = 2},
    [11] = {['seconds'] = 28, max = 25000, police = 2},
    [12] = {['seconds'] = 22, max = 25000, police = 2},
    [13] = {['seconds'] = 35, max = 25000, police = 2},

    [14] = {['seconds'] = 20, max = 25000, police = 5},
    [15] = {['seconds'] = 20, max = 25000, police = 5},
    [16] = {['seconds'] = 20, max = 25000, police = 5},
    [17] = {['seconds'] = 20, max = 25000, police = 5},
    [18] = {['seconds'] = 20, max = 25000, police = 5},
    [19] = {['seconds'] = 20, max = 25000, police = 5},
    [20] = {['seconds'] = 20, max = 25000, police = 5},

    [21] = {['seconds'] = 20, max = 25000, police = 2},
    [22] = {['seconds'] = 20, max = 25000, police = 2},
    [23] = {['seconds'] = 20, max = 25000, police = 2}

}
function func.VerificarValor(id)

    local valor = math.random(25000, caixas[id].max)
