...
emP = Tunnel.getInterface("emp_drogas_entrega")
...
local Coordenadas = {
    {-198.02, -1598.19, 34.91}, -- -198.02,-1598.19,34.91 groove
    {84.3, -1966.68, 20.94}, -- 84.3,-1966.68,20.94    ballas
    {342.1, -2074.94, 20.94}, -- 342.1,-2074.94,20.94 vagos
    {-1386.62,-589.67,30.32} -- -1386.07,-627.27,30.81 BAHAMAS
}
                    ...
                    if distance <= 1.2 then
                        ...
                        if IsControlJustPressed(0, 38)  then
                            if GetDistanceBetweenCoords(
                                GetEntityCoords(PlayerPedId()), -198.02, -1598.19, 34.91, true) <= 1.2 then
                                servico = true
                                inicio = 1
                                fim = 20
                            ...
                            elseif GetDistanceBetweenCoords(
                                ...
                                CriandoBlip(locs, selecionado)
                            elseif GetDistanceBetweenCoords(
                                GetEntityCoords(PlayerPedId()), 342.1, -2074.94, 20.94, true) <= 1.2 then
                                servico = true
                                inicio = 1
                                fim = 20
                                selecionado = math.random(inicio, fim)
                                CriandoBlip(locs, selecionado)
                                elseif GetDistanceBetweenCoords(
                                GetEntityCoords(PlayerPedId()), -1386.62,-589.67,30.32, true) <= 1.2 then
                                servico = true
                                inicio = 21
                                fim = 35
                                selecionado = math.random(inicio, fim)
