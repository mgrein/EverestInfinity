...
RegisterCommand('toogle',function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if vRP.hasPermission(user_id,"policia.permissao") then
		DISCORD_WEBHOOK = "https://discordapp.com/api/webhooks/676619281999593472/HLS-D9dQZy5ijA5uWQZjEhNWhEZS52uhDQRlZl-hI2HXrf4o8E5IinVdR45G9ezOgdKu"
	...
	elseif vRP.hasPermission(user_id,"paramedico.permissao") then
		DISCORD_WEBHOOK = "https://discordapp.com/api/webhooks/676619486866178048/NzJxGjF02ncGDiVlZDLzQkGaY9QvB2Y3Pqn2jnMUSANBwU6vHFssV7afp4UuOu0ZOuzK"
