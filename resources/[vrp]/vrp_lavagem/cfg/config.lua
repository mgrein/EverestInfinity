...
cfg.lavagem = { --Coordenadas dos pontos de Hack
	{355.78,4846.95,-62.59}, --Casa do Lester
}

cfg.lavagemcoord = vector3(355.78,4846.95,-62.59)
...
cfg.permissao = "mafia2.permissao" --PERMISSÃO PARA USAR A PLATAFORMA

cfg.lavagemporcento = 1.0 --DEIXA AÍ MESMO QUE JÁ É DIFÍCIL PAKASS P CHAMAR A POLÍCIA
