...
local animacoes = {
	...
	{ nome = "tablet" , dict = "amb@code_human_in_bus_passenger_idles@female@tablet@idle_a" , anim = "adle_b" , prop = "prop_cs_tablet" , flag = 49 , hand = 28422 },
	...
	{ nome = "naruto" , dict =  "missfbi1" , anim = "ledge_loop", andar = true , loop = false },
    { nome = "heroi" , dict = "rcmbarry" , anim = "base", andar = true , loop = false },
    { nome = "palhaco" , dict = "rcm_barry2", anim = "clown_idle_0", andar = false , loop = false },
    { nome = "palhaco1" , dict = "rcm_barry2", anim = "clown_idle_1", andar = false , loop = false },
    { nome = "palhaco2" , dict = "rcm_barry2", anim = "clown_idle_2", andar = false , loop = false },
    { nome = "palhaco3" , dict = "rcm_barry2", anim = "clown_idle_3", andar = false , loop = false },
    { nome = "palhaco4" , dict = "rcm_barry2", anim = "clown_idle_6", andar = false , loop = false },
	{ nome = "uncuff" , dict  = "mp_arresting", anim = "a_uncuff", andar = false , loop = false },
	{ nome = "mexer" , dict = "amb@prop_human_parking_meter@female@idle_a" , anim = "idle_a_female" , andar = true , loop = true },
    { nome = "honrar" , dict  = "veh@bike@police@front@base", anim = "goggles_down", andar = true , loop = false },
	...
	{ nome = "casalm" , dict = "misscarsteal2chad_goodbye" , anim = "chad_armsaround_chad" , andar = false , loop = true },
    { nome = "casalf" , dict = "misscarsteal2chad_goodbye" , anim = "chad_armsaround_girl" , andar = false , loop = true },
...
---MODO
--------------------------------------------------------------------
RegisterCommand("modo",function(source,args)
	if args[1] == '1' then
		if DoesEntityExist(PlayerPedId()) and not IsEntityDead(PlayerPedId()) then
			loadAnimDict("amb@world_human_seat_wall@female@hands_by_sides@base")
			if IsEntityPlayingAnim(PlayerPedId(),"amb@world_human_seat_wall@female@hands_by_sides@base","base",3) then
				vRP.DeletarObjeto()
				TaskPlayAnim(PlayerPedId(),"amb@world_human_seat_wall@female@hands_by_sides@base","exit",3.0,1.0,-1,49,0,0,0,0 )
				ClearPedSecondaryTask(PlayerPedId())
			else
				TaskPlayAnim(PlayerPedId(),"amb@world_human_seat_wall@female@hands_by_sides@base","base",3.0,1.0,-1,33,0,0,0,0 )
			end
		end
	elseif args[1] == '2' then
		if DoesEntityExist(PlayerPedId()) and not IsEntityDead(PlayerPedId()) then
			loadAnimDict("amb@code_human_in_bus_passenger_idles@female@sit@base")
			if IsEntityPlayingAnim(PlayerPedId(),"amb@code_human_in_bus_passenger_idles@female@sit@base","base",3) then
				vRP.DeletarObjeto()
				TaskPlayAnim(PlayerPedId(),"amb@code_human_in_bus_passenger_idles@female@sit@base","exit",3.0,1.0,-1,49,0,0,0,0 )
				ClearPedSecondaryTask(PlayerPedId())
			else
				TaskPlayAnim(PlayerPedId(),"amb@code_human_in_bus_passenger_idles@female@sit@base","base",3.0,1.0,-1,33,0,0,0,0 )
			end
		end
	elseif args[1] == '3' then
		if DoesEntityExist(PlayerPedId()) and not IsEntityDead(PlayerPedId()) then
			loadAnimDict("amb@prop_human_seat_chair@female@arms_folded@base")
			if IsEntityPlayingAnim(PlayerPedId(),"amb@prop_human_seat_chair@female@arms_folded@base","base",3) then
				vRP.DeletarObjeto()
				TaskPlayAnim(PlayerPedId(),"amb@prop_human_seat_chair@female@arms_folded@base","exit",3.0,1.0,-1,49,0,0,0,0 )
				ClearPedSecondaryTask(PlayerPedId())
			else
				TaskPlayAnim(PlayerPedId(),"amb@prop_human_seat_chair@female@arms_folded@base","base",3.0,1.0,-1,33,0,0,0,0 )
			end
		end
	elseif args[1] == '4' then
		if DoesEntityExist(PlayerPedId()) and not IsEntityDead(PlayerPedId()) then
			loadAnimDict("amb@prop_human_seat_chair@female@legs_crossed@base")
			if IsEntityPlayingAnim(PlayerPedId(),"amb@prop_human_seat_chair@female@legs_crossed@base","base",3) then
				vRP.DeletarObjeto()
				TaskPlayAnim(PlayerPedId(),"amb@prop_human_seat_chair@female@legs_crossed@base","exit",3.0,1.0,-1,49,0,0,0,0 )
				ClearPedSecondaryTask(PlayerPedId())
			else
				TaskPlayAnim(PlayerPedId(),"amb@prop_human_seat_chair@female@legs_crossed@base","base",3.0,1.0,-1,33,0,0,0,0 )
			end
		end
	elseif args[1] == '5' then
		if DoesEntityExist(PlayerPedId()) and not IsEntityDead(PlayerPedId()) then
			loadAnimDict("amb@prop_human_seat_chair@male@elbows_on_knees@base")
			if IsEntityPlayingAnim(PlayerPedId(),"amb@prop_human_seat_chair@male@elbows_on_knees@base","base",3) then
				vRP.DeletarObjeto()
				TaskPlayAnim(PlayerPedId(),"amb@prop_human_seat_chair@male@elbows_on_knees@base","exit",3.0,1.0,-1,49,0,0,0,0 )
				ClearPedSecondaryTask(PlayerPedId())
			else
				TaskPlayAnim(PlayerPedId(),"amb@prop_human_seat_chair@male@elbows_on_knees@base","base",3.0,1.0,-1,33,0,0,0,0 )
			end
		end
	elseif args[1] == '6' then
		if DoesEntityExist(PlayerPedId()) and not IsEntityDead(PlayerPedId()) then
			loadAnimDict("amb@prop_human_seat_chair@male@left_elbow_on_knee@base")
			if IsEntityPlayingAnim(PlayerPedId(),"amb@prop_human_seat_chair@male@left_elbow_on_knee@base","base",3) then
				vRP.DeletarObjeto()
				TaskPlayAnim(PlayerPedId(),"amb@prop_human_seat_chair@male@left_elbow_on_knee@base","exit",3.0,1.0,-1,49,0,0,0,0 )
				ClearPedSecondaryTask(PlayerPedId())
			else
				TaskPlayAnim(PlayerPedId(),"amb@prop_human_seat_chair@male@left_elbow_on_knee@base","base",3.0,1.0,-1,33,0,0,0,0 )
			end
		end
	elseif args[1] == '7' then
		if DoesEntityExist(PlayerPedId()) and not IsEntityDead(PlayerPedId()) then
			loadAnimDict("amb@prop_human_seat_strip_watch@female@base")
			if IsEntityPlayingAnim(PlayerPedId(),"amb@prop_human_seat_strip_watch@female@base","base",3) then
				vRP.DeletarObjeto()
				TaskPlayAnim(PlayerPedId(),"amb@prop_human_seat_strip_watch@female@base","exit",3.0,1.0,-1,49,0,0,0,0 )
				ClearPedSecondaryTask(PlayerPedId())
			else
				TaskPlayAnim(PlayerPedId(),"amb@prop_human_seat_strip_watch@female@base","base",3.0,1.0,-1,33,0,0,0,0 )
			end
		end
	elseif args[1] == '8' then
		if DoesEntityExist(PlayerPedId()) and not IsEntityDead(PlayerPedId()) then
			loadAnimDict("amb@world_human_seat_steps@female@hands_by_sides@base")
			if IsEntityPlayingAnim(PlayerPedId(),"amb@world_human_seat_steps@female@hands_by_sides@base","base",3) then
				vRP.DeletarObjeto()
				TaskPlayAnim(PlayerPedId(),"amb@world_human_seat_steps@female@hands_by_sides@base","exit",3.0,1.0,-1,49,0,0,0,0 )
				ClearPedSecondaryTask(PlayerPedId())
			else
				TaskPlayAnim(PlayerPedId(),"amb@world_human_seat_steps@female@hands_by_sides@base","base",3.0,1.0,-1,33,0,0,0,0 )
			end
		end
	elseif args[1] == '9' then
		if DoesEntityExist(PlayerPedId()) and not IsEntityDead(PlayerPedId()) then
			loadAnimDict("amb@world_human_seat_steps@male@elbows_on_knees@base")
			if IsEntityPlayingAnim(PlayerPedId(),"amb@world_human_seat_steps@male@elbows_on_knees@base","base",3) then
				vRP.DeletarObjeto()
				TaskPlayAnim(PlayerPedId(),"amb@world_human_seat_steps@male@elbows_on_knees@base","exit",3.0,1.0,-1,49,0,0,0,0 )
				ClearPedSecondaryTask(PlayerPedId())
			else
				TaskPlayAnim(PlayerPedId(),"amb@world_human_seat_steps@male@elbows_on_knees@base","base",3.0,1.0,-1,33,0,0,0,0 )
			end
		end
	elseif args[1] == '10' then
		if DoesEntityExist(PlayerPedId()) and not IsEntityDead(PlayerPedId()) then
			loadAnimDict("amb@world_human_seat_steps@male@hands_in_lap@base")
			if IsEntityPlayingAnim(PlayerPedId(),"amb@world_human_seat_steps@male@hands_in_lap@base","base",3) then
				vRP.DeletarObjeto()
				TaskPlayAnim(PlayerPedId(),"amb@world_human_seat_steps@male@hands_in_lap@base","exit",3.0,1.0,-1,49,0,0,0,0 )
				ClearPedSecondaryTask(PlayerPedId())
			else
				TaskPlayAnim(PlayerPedId(),"amb@world_human_seat_steps@male@hands_in_lap@base","base",3.0,1.0,-1,33,0,0,0,0 )
			end
		end
	elseif args[1] == '11' then
		if DoesEntityExist(PlayerPedId()) and not IsEntityDead(PlayerPedId()) then
			loadAnimDict("amb@world_human_seat_wall@male@hands_by_sides@base")
			if IsEntityPlayingAnim(PlayerPedId(),"amb@world_human_seat_wall@male@hands_by_sides@base","base",3) then
				vRP.DeletarObjeto()
				TaskPlayAnim(PlayerPedId(),"amb@world_human_seat_wall@male@hands_by_sides@base","exit",3.0,1.0,-1,49,0,0,0,0 )
				ClearPedSecondaryTask(PlayerPedId())
			else
				TaskPlayAnim(PlayerPedId(),"amb@world_human_seat_wall@male@hands_by_sides@base","base",3.0,1.0,-1,33,0,0,0,0 )
			end
		end
	elseif args[1] == '12' then
		if DoesEntityExist(PlayerPedId()) and not IsEntityDead(PlayerPedId()) then
			loadAnimDict("amb@world_human_seat_wall@male@hands_in_lap@base")
			if IsEntityPlayingAnim(PlayerPedId(),"amb@world_human_seat_wall@male@hands_in_lap@base","base",3) then
				vRP.DeletarObjeto()
				TaskPlayAnim(PlayerPedId(),"amb@world_human_seat_wall@male@hands_in_lap@base","exit",3.0,1.0,-1,49,0,0,0,0 )
				ClearPedSecondaryTask(PlayerPedId())
			else
				TaskPlayAnim(PlayerPedId(),"amb@world_human_seat_wall@male@hands_in_lap@base","base",3.0,1.0,-1,33,0,0,0,0 )
			end
		end
	elseif args[1] == '13' then
		if DoesEntityExist(PlayerPedId()) and not IsEntityDead(PlayerPedId()) then
			loadAnimDict("anim@amb@clubhouse@boardroom@crew@male@var_c@base@")
			if IsEntityPlayingAnim(PlayerPedId(),"anim@amb@clubhouse@boardroom@crew@male@var_c@base@","base",3) then
				vRP.DeletarObjeto()
				TaskPlayAnim(PlayerPedId(),"anim@amb@clubhouse@boardroom@crew@male@var_c@base@","exit",3.0,1.0,-1,49,0,0,0,0 )
				ClearPedSecondaryTask(PlayerPedId())
			else
				TaskPlayAnim(PlayerPedId(),"anim@amb@clubhouse@boardroom@crew@male@var_c@base@","base",3.0,1.0,-1,33,0,0,0,0 )
			end
		end
	end
end)
...
Citizen.CreateThread(function()
    while true do
        ...
        if IsControlJustPressed(0,38) then
            ...
            if camera then
                local scaleform = RequestScaleformMovie("Everest_News")
