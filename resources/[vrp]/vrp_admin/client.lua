...
AddEventHandler('deletarveiculo',function(distance)
    ...
    if IsEntityAVehicle(vehicle) then
        TriggerServerEvent("vrp_garages",VehToNet(vehicle),GetVehicleEngineHealth(vehicle),GetVehicleBodyHealth(vehicle),GetVehicleFuelLevel(vehicle))
...
AddEventHandler("vehtuning",function()
	...
	if IsEntityAVehicle(vehicle) then
		...
		-- SetVehicleNumberPlateText(veh,"EVEREST")
...
-- TRANSFORMAR EM NPC
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent('npctransform')
AddEventHandler('npctransform',function(modelhash)
