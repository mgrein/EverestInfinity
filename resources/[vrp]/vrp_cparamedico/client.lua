...
func = Tunnel.getInterface("vrp_cparamedico")

funcClient = {}
Tunnel.bindInterface("vrp_cparamedico", funcClient)
...
local listaPcs = {
    {x= 308.6, y=-594.88, z=43.29, h=356.00},
    
}

local teste = 1
Citizen.CreateThread(function()
    if func.isParamedico() then
